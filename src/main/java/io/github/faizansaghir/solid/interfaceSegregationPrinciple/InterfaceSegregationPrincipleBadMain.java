...
import io.github.faizansaghir.solid.interfaceSegregationPrinciple.bad.OrderPersistenceService;
import io.github.faizansaghir.solid.interfaceSegregationPrinciple.bad.UserPersistenceService;
...
public class InterfaceSegregationPrincipleBadMain {
    public static void main(String[] args) {
        ...
        try{
            System.out.printf("Order with name \"OrderName\": %s\n",orderPersistenceService.getByName("OrderName").toString());
        }
        catch (Exception e) {
